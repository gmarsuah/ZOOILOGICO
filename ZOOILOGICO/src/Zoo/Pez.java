...
public class Pez extends Animal {
    ...
    // public Pez(String nombre, String edad, String peso, String tamaño, String
    // colorescamas, String tipoAgua) {
    ...
    public void respirarBajoAgua() {
        ...
        System.out.println(nombre
                + " está abriendo y cerrando la boca para así poder hacer que el agua pase por la branqueas para asi conseguir el oxígeno");
    }
